...
global $Form1 = GUICreate("Sam's Tool",$mWidth, $mHeight, 50, 50,$WS_SIZEBOX+$WS_MAXIMIZEBOX+$WS_MINIMIZEBOX)    ; Create the GUI window and set its properties
...
$hWnd = WinGetHandle("Sam's Tool")  ; Get the handle of the GUI window
